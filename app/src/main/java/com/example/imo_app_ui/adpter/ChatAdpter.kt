...
class ChatAdpter(var context: Context,var items: ArrayList<Chat>):RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    class MessageViewHolder(var view: View):RecyclerView.ViewHolder(view){
        ...
        init {
            ...
            tv_fullname = view.findViewById<TextView>(R.id.tv_fullName)
